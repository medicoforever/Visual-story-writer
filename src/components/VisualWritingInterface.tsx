...
export default function VisualWritingInterface() {
  ...
  useEffect(() => {
    ...
    if(visualPanelRef.current) {
        // FIX: Corrected typo from visualPanel-current to visualPanelRef.current
    ...
    // FIX: Changed dependencies from full objects to their length to prevent re-running layout on every position change.
