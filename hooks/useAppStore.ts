...
export const useAppStore = create<AppState>((set, get) => ({
  ...
  actions: {
    ...
    setEntityNodes: (nodes) => set(state => ({ entityNodes: typeof nodes === 'function' ? nodes(state.entityNodes) : nodes })),
    setLocationNodes: (nodes) => set(state => ({ locationNodes: typeof nodes === 'function' ? nodes(state.locationNodes) : nodes })),
